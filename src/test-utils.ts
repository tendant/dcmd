...
export const commandMocks = {
  ...
  startupInfo: vi.fn(async () => ({ startDir: "/", settings: { version: 1, splitRatio: 0.5, left: { sortKey: "name", sortAscending: true, showHidden: false }, right: { sortKey: "name", sortAscending: true, showHidden: false }, columns: { size: 64, modified: 64 } } })),
};
